...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/MovieRecommender/releases/download/v1.0.0/MovieRecommender-main.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/MovieRecommender/raw/main/requirements.txt
SET REPO_NAME=MovieRecommender-main.zip
SET EXTRACTED_REPO_DIR=MovieRecommender-main
