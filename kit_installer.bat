...
ECHO======================================================================================
SET KIT_NAME=movie-recommender
...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/MovieRecommender/releases/download/v1.0.0/MovieRecommender.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/MovieRecommender/raw/main/requirements.txt
SET REPO_NAME=MovieRecommender.zip
SET EXTRACTED_REPO_DIR=MovieRecommender
SET NOTEBOOK_NAME=MovieRecommender.ipynb
SET GET_PIP_LOCATION=https://bootstrap.pypa.io/get-pip.py
SET VIRTUALENV_NAME=!KIT_NAME!-env
